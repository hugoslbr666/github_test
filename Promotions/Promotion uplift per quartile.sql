...
non_intra AS (
SELECT
coalesce(segment,'4. Bottom 25%') segment,
...
left join quartile_split on quartile_split.artist_id = i.item_brand
...
AND ((ge.event_date BETWEEN '2024-11-12' AND '2024-12-02')
